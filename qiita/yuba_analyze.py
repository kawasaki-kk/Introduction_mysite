...
def recommend_Qiita(title, content, recommend_num = 4, learned_model_file_name = ""):
	recommender = client.Recommender("127.0.0.1", 9199, NAME)
	if learned_model_file_name:
		recommender.load(learned_model_file_name) #保存した学習モデルを読み込む
...
if __name__ == '__main__':
	...
	nippo = [
			"日報テスト",
				 "Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。Pythonが好きだ。"
		]
