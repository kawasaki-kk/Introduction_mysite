...
URL_ITEMS     = "https://qiita.com/api/v1/items"
URL_TAG_ITEMS = "https://qiita.com/api/v1/tags/%s/items"
URL_TAGS      = "https://qiita.com/api/v1/tags"
...
if __name__ == '__main__':
	for data in tags():
		...
		item_id = data["name"]
		filename = "data/test/%s.json" % item_id
		try:
			with codecs.open(filename, "w", "utf-8") as f:
